...
def start(update, context):
	...
	update.message.reply_text('Go to /weather ' )
...
def coordinates_handler(update, context):
	reply_markup = telegram.ReplyKeyboardMarkup([[telegram.KeyboardButton(item) for item in WEATHER_CONVERSATION_COMMANDS]])
